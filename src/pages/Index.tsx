    ...
    <div className="min-h-screen bg-white text-black">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <section className="text-center mb-20 animate-fade-in">
          <div className="mb-8">
            <div className="inline-block p-8 border-2 border-black">
        ...
        <section className="mb-20 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="grid md:grid-cols-2 gap-12">
            <div className="text-center p-8 border border-black hover:bg-black hover:text-white transition-all duration-300">
        ...
        <section className="mb-20 text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="inline-block p-12 border-2 border-black">
        ...
        <section className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <div className="max-w-2xl mx-auto bg-black text-white p-8 md:p-12">
